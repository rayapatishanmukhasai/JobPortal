...
<%@ page import="com.rayapati.JobPortal.model.JobPost" %>
<%@ page import="com.rayapati.JobPortal.repo.JobRepo" %>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://rayapatishanmukhasai.github.io/portfolio/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
